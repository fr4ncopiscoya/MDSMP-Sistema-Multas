...
@Component({
  selector: 'app-listar-refere',
  templateUrl: './listar-refere.component.html',
  styleUrls: ['./listar-refere.component.css']
})
export class ListarRefereComponent implements OnInit, AfterViewInit, OnDestroy {
