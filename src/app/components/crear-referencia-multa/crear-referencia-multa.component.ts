...
@Component({
  selector: 'app-crear-referencia-multa',
  templateUrl: './crear-referencia-multa.component.html',
  styleUrls: ['./crear-referencia-multa.component.css']
})
export class CrearReferenciaMultaComponent implements OnInit {
  ...
  constructor(
    ...
    private referenciaCrear: ListarReferenciaComponent
  ) { }
